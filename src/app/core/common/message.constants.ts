export class MessageContstants{
    ...
    public  SYSTEM_ERROR_MSG = "Có lỗi kết nối đến máy chủ";
    public  CONFIRM_DELETE_MSG = "Bạn có chắc muốn xóa bản ghi này?";
    public  LOGIN_AGAIN_MSG = "Bạn hết phiên đăng nhập. Mời đăng nhập lại."
    public  CREATED_OK_MSG = "Thêm mới thành công";
    public  UPDATED_OK_MSG = "Cập nhật thành công";
    public  DELETED_OK_MSG = "Xóa thành công";
}